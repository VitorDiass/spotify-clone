...
const InfoCard = ({ data }: props) => {
  ...
  return (
    <a href={data?.linkTo}>
      <div className="flex flex-col min-h-[285px] bg-spotify-playpanel-bg rounded-md p-3 hover:bg-spotify-divider-color cursor-pointer group">
        <div className="mb-4 relative">
          ...
          <img
            ...
            className={`relative min-h-[155px] object-contain shadow-2xl ${
              data.tag === "Album" ? "rounded-lg" : "rounded-full"
            }`}
            height={155}
            width={155}
          />
